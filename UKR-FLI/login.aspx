              ...
              <div class="cell-sm-8 cell-md-6 cell-lg-4">
                 <!-- RD Mailform-->
                  ...
                  <div class="form-group">
                    ...
                    <asp:TextBox id="tb_login" class="form-control form-control-gray form-control-has-validation form-control-last-child" type="text" name="login" runat="server"></asp:TextBox>
                  </div>
                  <div class="form-group">
                    <label class="form-label form-label-outside" for="password">Password</label>
                    <asp:TextBox  id="tb_password" class="form-control form-control-gray form-control-has-validation form-control-last-child" type="password" name="password" runat="server"></asp:TextBox>
                  </div>
